...
public class Clock extends View {
    ...
    private float UNIT_DEGREE = (float) (6 * Math.PI / 180);// 一个小格的度数，更改它实现分针更流畅的走动
    ...
    private void drawNeedles(final Canvas canvas) {
        ...
        // 画分针
        // todo 画分针
        drawPointer(canvas,1,nowMinutes);//分针也是和秒针跳变相同度数
        // 画时针
    ...
    private void drawPointer(Canvas canvas, int pointerType, int value) {
        ...
        switch (pointerType) {
            ...
            case 1:
                // todo 画分针，设置分针的颜色
                degree = value * UNIT_DEGREE;
                mNeedlePaint.setColor(Color.BLUE);//为什么setColor不会被索引出来？？
